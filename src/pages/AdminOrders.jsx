      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 animate-fade-in">
          <div className="flex items-center space-x-3 mb-3">
            ...
            <div>
              <h1 className="text-4xl font-extrabold text-gray-900 bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">All Orders</h1>
              <p className="text-gray-600 font-medium">View all customer orders and transactions</p>
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-3d p-12 text-center border border-gray-200 animate-slide-up">
            <svg className="mx-auto h-12 w-12 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
            </svg>
